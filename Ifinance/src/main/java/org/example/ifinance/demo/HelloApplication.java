    ...
    private VBox createMonthlyReportForm() {
        ...
        generateBtn.setOnAction(e -> {
            ...
            for (String cat : new String[]{
                ...
                expense += expenceDAO.getTotalExpenseByCategoryAndMonthcurr(cat, year, month);
            }
            ...
            if(year == LocalDate.now().getYear() && month == LocalDate.now().getMonthValue()){
                for (String cat : new String[]{
                    ...
                    double total = expenceDAO.getTotalExpenseByCategoryAndMonthcurr(cat, year, month);
                    catData.add(new CategoryExpense(cat, total));
                }
            }else{
            for (String cat : new String[]{
                    "Education_m","Transport_m","Household_m","Tour_m","Refreshment_m","Food_m","Others_m"
            }) {
